...
<div class="category-tab shop-details-tab"><!--category-tab-->
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="details">
            <p style="margin-left: 20px;">{!!$value->product_desc!!}</p>
            <!-- Xuất ra dưới dạng đặc biệt khi được styling trước -->
        </div>

        <div class="tab-pane fade" id="companyprofile">
            <p style="margin-left: 20px;">{!!$value->product_content!!}</p>
                    ...
                    <div class="product-image-wrapper">
                        <div class="single-products">
                            <div class="productinfo text-center">
                                <img src="{{URL::to('public/uploads/product/'.$product_relate->product_image)}}" alt="" />
                                <h2>{{'$ '.number_format($product_relate->product_price)}}</h2>
