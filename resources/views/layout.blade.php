                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/danh-muc-san-pham/'.$cate_item->category_id)}}">{{$cate_item->category_name}}</a></h4>
                                </div>
                            </div>
                            @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand_item->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand_item->brand_name}}</a></li>
                            </div>
                            @endforeach
                        </div><!--/brands_products-->
